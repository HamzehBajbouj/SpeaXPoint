...
class GrammmaticalNotesObservationsTabView extends StatefulWidget {
  const GrammmaticalNotesObservationsTabView(
      {super.key,
  ...
  @override
  State<GrammmaticalNotesObservationsTabView> createState() =>
      _GrammmaticalNotesObservationsTabViewState();
}

class _GrammmaticalNotesObservationsTabViewState
    extends State<GrammmaticalNotesObservationsTabView> {
    ...
    return Padding(
      ...
      child: Expanded(
        child: StreamBuilder<List<GrammarianNote>>(
          stream: _speechObservationsViewModel!.getAllGrammaticalNotes(
          ...
          builder: (context, snapshot) {
            if (!snapshot.hasData) {
              ...
              notes.sort(
                  (a, b) => b.noteCapturedTime!.compareTo(a.noteCapturedTime!));

              if (notes.isEmpty) {
                return const Center(
                  child: Text(
                    "You Do Not Have Any Grammatical Notes Yet.",
                    style: TextStyle(
